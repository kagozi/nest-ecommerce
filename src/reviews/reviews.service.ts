...
export class ReviewsService {
  ...
  async addReview(userId: number, productId: number, createReviewDto: ReviewDto): Promise<Review> {
  ...
  async updateReview(userId: number, reviewId: number, updateReviewDto: ReviewDto): Promise<Review> {
